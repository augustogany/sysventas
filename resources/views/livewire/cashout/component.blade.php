                            ...
                            <tbody>
                                ...
                                @foreach ($sales as $item)
                                    <tr>
                                        ...
                                        <td class="text-center"><h6>Bs{{number_format($item->total,2)}}</h6></td>
                                        <td class="text-center"><h6>{{$item->items}}</h6></td>
                                        <td class="text-center"><h6>{{$item->created_at}}</h6></td>
                                        <td class="text-center">
                                            <button wire:click.prevent="viewDetails({{$item}})" class="btn btn-dark btn-sm">
